...
class MatchDetailController extends ChangeNotifier {
  ...
  /*****************************************************************************
   * get Stats List by Series Id
   * *******************************************************************************/


  List seriesStatsList = [];
  bool seriesStatsListLoading = true;
  Future<void> getSeriesStatsListData(context, String seriesId, String type1st, String type2nd) async {
    seriesStatsListLoading = true;
    seriesStatsList = [];
    var request = http.MultipartRequest('POST', Uri.parse(Constant.seriesStatsBySeriesId));
    request.fields.addAll({
      "series_id" : seriesId,
      "type" : type1st,
      "sub_type" : type2nd,
    ...
    try{
      ...
      if(response.statusCode == 200 || response.statusCode == 201){
        ...
        notifyListeners();
        if(data['status'] == true){
          if(type1st == "1" && type2nd == "1"){
            seriesStatsList = data["data"]["most_runs"];
          }
          if(type1st == "1" && type2nd == "2"){
            seriesStatsList = data["data"]["highest_scores"];
          }
          if(type1st == "1" && type2nd == "3"){
            seriesStatsList = data["data"]["batting_avg"];
          }
          if(type1st == "1" && type2nd == "4"){
            seriesStatsList = data["data"]["batting_sr"];
          }
          if(type1st == "1" && type2nd == "5"){
            seriesStatsList = data["data"]["most_hundreds"];
          }
          if(type1st == "1" && type2nd == "6"){
            seriesStatsList = data["data"]["most_fifty"];
          }
          if(type1st == "1" && type2nd == "7"){
            seriesStatsList = data["data"]["most_fours"];
          }
          if(type1st == "1" && type2nd == "8"){
            seriesStatsList = data["data"]["most_sixes"];
          }
          if(type1st == "1" && type2nd == "9"){
            seriesStatsList = data["data"]["most_nineties"];
          }

          if(type1st == "2" && type2nd == "1"){
            seriesStatsList = data["data"]["most_wickets"];
          }
          if(type1st == "2" && type2nd == "2"){
            seriesStatsList = data["data"]["most_five_wickets"];
          }
          if(type1st == "2" && type2nd == "3"){
            seriesStatsList = data["data"]["most_bowling"];
          }
          if(type1st == "2" && type2nd == "4"){
            seriesStatsList = data["data"]["best_economy"];
          }
          Timer(const Duration(milliseconds: 100),(){
            seriesStatsListLoading = false;
            notifyListeners();
          });
        }else{
          showToast(data['msg']);
